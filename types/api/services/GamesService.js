...
class GamesService {
   ...
   * @throws ApiError
   */
  static gamesAdditionsList(gamePk, page, pageSize) {
    return (0, request_1.request)(OpenAPI_1.OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  static gamesDevelopmentTeamList(gamePk, ordering, page, pageSize) {
    return (0, request_1.request)(OpenAPI_1.OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  static gamesGameSeriesList(gamePk, page, pageSize) {
    return (0, request_1.request)(OpenAPI_1.OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  static gamesParentGamesList(gamePk, page, pageSize) {
    return (0, request_1.request)(OpenAPI_1.OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  static gamesScreenshotsList(gamePk, ordering, page, pageSize) {
    return (0, request_1.request)(OpenAPI_1.OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  static gamesStoresList(gamePk, ordering, page, pageSize) {
    return (0, request_1.request)(OpenAPI_1.OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  static gamesAchievementsRead(id) {
    return (0, request_1.request)(OpenAPI_1.OpenAPI, {
      method: 'GET',
